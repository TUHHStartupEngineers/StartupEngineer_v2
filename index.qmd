...
<div class="objectives" label="#affiliations">
    ...
    <div class="container text-center py-5" style="max-width: 100%;">
        <a href="https://www.tuhh.de/tuhh/startseite" style="margin-left: 20px; margin-right: 20px; text-decoration: none">
          <img class="m-3" src="assets/logo/partners/TUHH.svg" style="max-width: 200px;transform: scale(1);" />
        </a>
        <a href="[#](https://www.mle.hamburg/)" style="margin-left: 20px; margin-right: 20px; text-decoration: none">
          <img class="m-3" src="assets/logo/partners/mle.svg" style="max-width: 200px;" href="https://www.tuhh.de/tuhh/startseite"/>
        </a>
        <a href="http://druid.dk/" style="margin-left: 20px; margin-right: 20px; text-decoration: none">
          <img class="m-3" src="assets/logo/partners/druid.png" style="max-width: 200px;filter: grayscale(100%);" />
        </a>
        <a href="http://aom.org/" style="margin-left: 20px; margin-right: 20px; text-decoration: none">
          <img class="m-3" src="assets/logo/partners/AOM.png" style="max-width: 200px;filter: grayscale(100%);" />
        </a>
        <a href="http://www.egosnet.org/" style="margin-left: 20px; margin-right: 20px; text-decoration: none">
          <img class="m-3" src="assets/logo/partners/vhbtie.png" style="max-width: 200px;filter: grayscale(100%);" />
        </a>
        <a href="https://www.the-klu.org/event-pages/oui-conference-2023/" style="margin-left: 20px; margin-right: 20px; text-decoration: none">
          <img class="m-3" src="assets/logo/partners/oui.png" style="max-width: 200px;filter: grayscale(100%);" />
        </a>
        <a href="https://www.vhbonline.org/wk-/-fachgruppen/technologie-innovation-und-entrepreneurship-tie" style="margin-left: 20px; margin-right: 20px; text-decoration: none">
